...
#爱奇艺cookie
P00003 = getenv("P00003")
iqiyi_dfp = getenv("dfp")
# P00001 多账号用&隔开
P00001_list = getenv("P00001").split('&')
...
class Iqiyi:
    ...
    def pushplus(self, title, content):
        ...
        resp = post(url, json=data, headers={'Content-Type': 'application/json'},timeout=100)
        print(resp.text)
